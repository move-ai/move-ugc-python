...
def validate_list_items_type(  # noqa: WPS231
    ...
    Raises:
        KeyError: If the __typename is not found in the mapping_type_name_to_class.
    """
    ...
    if list_items:
        try:
            ...
            raise KeyError(
                f"Got __typename of {exc} which not present in mapping_type_name_to_class: {', '.join(mapping_type_name_to_class.keys())}",  # noqa: WPS237
            )
